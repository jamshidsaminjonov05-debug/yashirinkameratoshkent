  ...
  return (
    <section style={{ padding: '60px 20px' }}>
      <div
        ...
        style={{ background: 'linear-gradient(135deg, #1a0e08, #2a1508)', border: '1px solid rgba(245, 166, 35,0.3)', borderRadius: 24, padding: 'clamp(32px, 5vw, 60px)', textAlign: 'center', position: 'relative', overflow: 'hidden', boxShadow: '0 0 60px rgba(245, 166, 35,0.1)' }}
      >
        <div data-parallax="40" style={{ position: 'absolute', top: -60, left: '50%', transform: 'translateX(-50%)', width: 300, height: 300, borderRadius: '50%', background: 'radial-gradient(circle, rgba(245, 166, 35,0.15), transparent 70%)' }} />
        <p style={{ color: '#f5a623', fontSize: 12, fontWeight: 700, letterSpacing: 2, textTransform: 'uppercase', marginBottom: 12, position: 'relative' }}>{cta.eyebrow}</p>
