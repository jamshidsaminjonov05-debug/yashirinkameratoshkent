    ...
    <section id="maqolalar" style={{ padding: '80px 0' }}>
      <div className="max-w-screen-xl mx-auto px-5">
        <div className="reveal text-center mb-12">
          <p style={{ color: '#1ea832', fontSize: 12, fontWeight: 700, letterSpacing: 2, textTransform: 'uppercase', marginBottom: 8 }}>{blog.eyebrow}</p>
          ...
          {blog.posts.map((post) => (
            <HoverLift key={post.slug} as="article" className="card card-hover" style={{ overflow: 'hidden' }}>
              <div style={{ position: 'relative', overflow: 'hidden', height: 200 }}>
                ...
                <div style={{ position: 'absolute', top: 12, left: 12, background: 'rgba(30,168,50,0.9)', color: '#fff', fontSize: 10, fontWeight: 700, padding: '3px 10px', borderRadius: 999 }}>{post.tag}</div>
              </div>
              <div style={{ padding: 20 }}>
                ...
                <div className="flex items-center gap-2 mt-4">
                  <span style={{ width: 28, height: 28, borderRadius: '50%', background: 'rgba(30,168,50,0.16)', color: '#4ade80', display: 'flex', alignItems: 'center', justifyContent: 'center' }} aria-hidden="true">
